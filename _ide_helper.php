...
')
     ...
     */
         ...
         * @static
         */
        public static function ConnectAndPublish($topic, $msg, $client_id = null, $retain = null)
        {
                        /** @var \Salman\Mqtt\MqttClass\Mqtt $instance */
                        return $instance->ConnectAndPublish($topic, $msg, $client_id, $retain);
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function ConnectAndSubscribe($topic, $proc, $client_id = null)
        {
                        /** @var \Salman\Mqtt\MqttClass\Mqtt $instance */
                        return $instance->ConnectAndSubscribe($topic, $proc, $client_id);
        }
...
namespace  {
            ...
            class Mqtt extends \Salman\Mqtt\Facades\Mqtt {}
